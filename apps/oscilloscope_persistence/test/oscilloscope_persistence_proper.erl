-module(oscilloscope_persistence_proper).
...
prop_calculate_query_bounds() ->
    ?FORALL(
        ...
        begin
            ...
            Bounds = oscilloscope_persistence:calculate_query_bounds(
                From0,
                Until0,
                Interval,
                Persisted
...
prop_trim_read() ->
    ?FORALL(
        ...
        begin
            ...
            {StartTime, EndTime, Points} = oscilloscope_persistence:trim_read(
                From,
                Until,
                Interval,
                ReadFrom,
